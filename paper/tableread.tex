...
\pgfplotstableread[
		format=file,
		col sep=tab,
	]{alexa-rank.buckets.sorted.se.2014-07-10.random.100000-http-www.tsv}\tableAlexaRankBucketsSortedSeRandomHttpWww

\pgfplotstableread[
		format=file,
		col sep=tab,
	]{alexa-rank.buckets.sorted.alexa.2014-09-01.random.10000-http-www.tsv}\tableAlexaRankBucketsSortedAlexaRandomHttpWww

\pgfplotstableread[
		format=file,
		col sep=tab,
	]{alexa-rank.buckets.sorted.alexa.2014-09-01.top.10000-http-www.tsv}\tableAlexaRankBucketsSortedAlexaTopHttpWww

\pgfplotstableread[
		format=file,
		col sep=tab,
	]{alexa-rank.buckets.sorted.alexa.2014-09-01.top.se.10000-http-www.tsv}\tableAlexaRankBucketsSortedAlexaTopSeHttpWww

\pgfplotstableread[
		format=file,
		col sep=tab,
	]{alexa-rank.buckets.sorted.alexa.2014-09-01.top.dk.10000-http-www.tsv}\tableAlexaRankBucketsSortedAlexaTopDkHttpWww
