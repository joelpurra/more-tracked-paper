...
\pgfplotstableread[
		format=file,
		col sep=tab,
	]{datasets.non-failed.classification.domain-scope.coverage.sorted.sweden.tsv}\tableDatasetsNonFailedClassificationDomainScopeCoverageSortedSweden

\pgfplotstableread[
		format=file,
		col sep=tab,
	]{datasets.non-failed.disconnect.organizations.coverage.external.sorted.sweden.tsv}\tableDatasetsNonFailedDisconnectOrganizationsCoverageExternalSortedSweden

\pgfplotstableread[
		format=file,
		col sep=tab,
	]{datasets.non-failed.disconnect.categories.coverage.external.sorted.sweden.tsv}\tableDatasetsNonFailedDisconnectCategoriesCoverageExternalSortedSweden
...
\pgfplotstableread[
		format=file,
		col sep=tab,
	]{datasets.non-failed.classification.domain-scope.coverage.sorted.global.tsv}\tableDatasetsNonFailedClassificationDomainScopeCoverageSortedGlobal

\pgfplotstableread[
		format=file,
		col sep=tab,
	]{datasets.non-failed.disconnect.organizations.coverage.external.sorted.global.tsv}\tableDatasetsNonFailedDisconnectOrganizationsCoverageExternalSortedGlobal

\pgfplotstableread[
		format=file,
		col sep=tab,
	]{datasets.non-failed.disconnect.categories.coverage.external.sorted.global.tsv}\tableDatasetsNonFailedDisconnectCategoriesCoverageExternalSortedGlobal
